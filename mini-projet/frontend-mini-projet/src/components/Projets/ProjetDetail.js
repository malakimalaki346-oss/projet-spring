...
const ProjetDetail = () => {
    ...
    if (!projet) return <div className="loading">Projet non trouvé</div>;
        ...
        <div className="projet-detail">
            ...
            <div className="info-section">
                ...
                <div className="info-grid">
                    ...
                    <div><strong>Date début:</strong> {new Date(projet.dateDebut).toLocaleDateString()}</div>
                    ...
                    <tbody>
                        {phases.map(phase => (
                            <tr key={phase.id}>
                                ...
                                <td>
                                    <Link to={`/phases/${phase.id}`} className="btn-view">Détails</Link>
                                </td>
                            </tr>
                        ))}
                    </tbody>
